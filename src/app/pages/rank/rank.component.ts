...
changData(i : number){
    this.imgshow = this.Top10User[i].image;
    this.nameshow = this.Top10User[i].title;
    this.http.get(`${this.apiurl}/statistics/chat/`+this.Top10User[i].image_id).subscribe((data : any) => {this.ngAfterViewInit(data);});
}
...
Top10(){
  ...
  this.http.get(`${this.apiurl}/image/top10`).pipe(
    ...
    this.imgshow = this.Top10User[0].image;
    this.nameshow = this.Top10User[0].title;
    this.http.get(`${this.apiurl}/statistics/chat/`+this.Top10User[0].image_id).subscribe((data : any) => {this.ngAfterViewInit(data);});
  });
}
